...
class Landing extends StatefulWidget {
  final String passedrNum;
  const Landing({Key? key, required this.passedrNum}) : super(key: key);

  @override
  State<Landing> createState() => _LandingState(passedrNum: this.passedrNum);
}

class _LandingState extends State<Landing> {
  String passedrNum;
  _LandingState({required this.passedrNum});
